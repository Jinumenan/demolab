...
public class StartGmae extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState){
        ...
        map.put(techList.get(0),R.drawable.bootstap);
        ...
        map.put(techList.get(4),R.drawable.cshap);
        ...
        map.put(techList.get(11),R.drawable.node);
        ...
        Collections.shuffle(techList);//random question start
        ...
        countDownTimer = new CountDownTimer(millisUntilFinished,1000) {
            ...
            public void onFinish() {
                ...
                if(index > techList.size() - 1){
                    ...
                    Intent intent =  new Intent(StartGmae.this, GameOver.class);
